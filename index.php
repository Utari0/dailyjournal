...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
      <div class="container">
        <a class="navbar-brand" href="img/banner.jpg">My Daily Journal</a>
        <button
...
<section id="gallery" class="text-center p-5 bg-danger-subtle">
  <div class="container">
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          ...
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15405</h3>
            <h1 class="fw-bold">Utari Anggita Briliani</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>Utari Anggita Briliani &copy; 2024</div>
    </footer>
    <!-- footer end -->
